...
public static class Locomotion
{
    public static readonly string[] Tokens =
    {
        ...
        // walking and running. The two-letter verbs and the loop phase matter:
        // the player sets name their cycles _wk_/_rn_/_dh_/_jg_ with _lp_ for
        // the loop, and a plain run loop (snapnon_s_rn_lp_...) contains none of
        // the longer tokens -- without these, --locomotion silently drops the
        // most important clips in the game.
        "wal", "wlk", "walk", "_wk", "run", "_rn", "jog", "_jg",
        "dsh", "dash", "_dh", "spr", "sprint", "_lp",
